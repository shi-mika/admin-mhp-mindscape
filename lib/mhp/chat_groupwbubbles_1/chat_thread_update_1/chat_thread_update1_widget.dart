...
import 'chat_thread_update1_model.dart';
export 'chat_thread_update1_model.dart';

class ChatThreadUpdate1Widget extends StatefulWidget {
  const ChatThreadUpdate1Widget({
    super.key,
  ...
  @override
  _ChatThreadUpdate1WidgetState createState() =>
      _ChatThreadUpdate1WidgetState();
}

class _ChatThreadUpdate1WidgetState extends State<ChatThreadUpdate1Widget> {
  late ChatThreadUpdate1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatThreadUpdate1Model());
