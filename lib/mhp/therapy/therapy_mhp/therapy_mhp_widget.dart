...
import '/mhp/therapy/emptytherapy/emptytherapy_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:provider/provider.dart';
import 'package:webviewx_plus/webviewx_plus.dart';
import 'therapy_mhp_model.dart';
export 'therapy_mhp_model.dart';

class TherapyMhpWidget extends StatefulWidget {
  const TherapyMhpWidget({super.key});

  @override
  _TherapyMhpWidgetState createState() => _TherapyMhpWidgetState();
}

class _TherapyMhpWidgetState extends State<TherapyMhpWidget> {
  late TherapyMhpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TherapyMhpModel());
