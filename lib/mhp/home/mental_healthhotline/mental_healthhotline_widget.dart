...
import 'mental_healthhotline_model.dart';
export 'mental_healthhotline_model.dart';

class MentalHealthhotlineWidget extends StatefulWidget {
  const MentalHealthhotlineWidget({super.key});

  @override
  _MentalHealthhotlineWidgetState createState() =>
      _MentalHealthhotlineWidgetState();
}

class _MentalHealthhotlineWidgetState extends State<MentalHealthhotlineWidget>
    with TickerProviderStateMixin {
  late MentalHealthhotlineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MentalHealthhotlineModel());
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Search for Mental Health Hotlines...',
                    labelStyle:
