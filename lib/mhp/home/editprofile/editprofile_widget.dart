...
import '/mhp/home/profilepic/profilepic_widget.dart';
...
class _EditprofileWidgetState extends State<EditprofileWidget> {
  ...
  void initState() {
    ...
    _model.textController6 ??= TextEditingController(text: currentPhoneNumber);
    _model.textFieldFocusNode6 ??= FocusNode();

    _model.textController7 ??=
        TextEditingController(text: currentUserDocument?.birthDate?.toString());
    ...
    _model.textController11 ??= TextEditingController(
        text: valueOrDefault<bool>(currentUserDocument?.subscription, false)
            .toString());
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: const Color(0xFFF0D4C5),
        body: SafeArea(
          top: true,
