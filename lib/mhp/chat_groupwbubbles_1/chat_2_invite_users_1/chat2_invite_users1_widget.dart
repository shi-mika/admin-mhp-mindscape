...
import 'chat2_invite_users1_model.dart';
export 'chat2_invite_users1_model.dart';

class Chat2InviteUsers1Widget extends StatefulWidget {
  const Chat2InviteUsers1Widget({
    super.key,
    this.chatRef,
  });
  ...
  @override
  _Chat2InviteUsers1WidgetState createState() =>
      _Chat2InviteUsers1WidgetState();
}

class _Chat2InviteUsers1WidgetState extends State<Chat2InviteUsers1Widget> {
  late Chat2InviteUsers1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chat2InviteUsers1Model());
          ...
          title: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Select clients from below to start a chat.',
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      } else if (_model.friendsList.length > 2) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'You must select only one other user to start a chat.',
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                                    fontFamily: 'Readex Pro',
