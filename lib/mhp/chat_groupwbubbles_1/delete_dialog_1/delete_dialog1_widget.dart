...
import 'delete_dialog1_model.dart';
export 'delete_dialog1_model.dart';

class DeleteDialog1Widget extends StatefulWidget {
  const DeleteDialog1Widget({
    super.key,
    this.chatList,
  ...
  @override
  _DeleteDialog1WidgetState createState() => _DeleteDialog1WidgetState();
}

class _DeleteDialog1WidgetState extends State<DeleteDialog1Widget>
    with TickerProviderStateMixin {
  late DeleteDialog1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteDialog1Model());
