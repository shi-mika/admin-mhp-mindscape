...
import '/mhp/community/emptycomment/emptycomment_widget.dart';
import 'package:easy_debounce/easy_debounce.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'commentpopup_model.dart';
export 'commentpopup_model.dart';

class CommentpopupWidget extends StatefulWidget {
  const CommentpopupWidget({
    super.key,
  ...
  @override
  _CommentpopupWidgetState createState() => _CommentpopupWidgetState();
}

class _CommentpopupWidgetState extends State<CommentpopupWidget> {
  late CommentpopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentpopupModel());
